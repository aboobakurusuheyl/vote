<x-master-layout>
            ...
            <div class="lg:grid lg:grid-cols-12">
                ...
                <div class="relative bg-indigo-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                    ...
                    <div class="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                        <h2 class="text-3xl font-extrabold text-white" id="join-heading">Maldives Qualifications Authority</h2>
    ...
    <div class=" space-y-10">
        <div class=" flex flex-col items-center">
            ...
            <p class=" text-gray-400">"Quality Assured Education"</p>
        </div>

        <div class=" flex flex-col items-center">
            <h1 class=" font-bold text-3xl pb-4">Mission</h1>
            <p class=" text-gray-400">To facilitate quality assured higher education and training available to the citizens of the Maldives, Locally and Internationally</p>
        </div>
    </div>
