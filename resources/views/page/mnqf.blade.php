                        ...
                        <dt class="text-lg">
                            ...
                            <button type="button" class="text-left w-full flex justify-between items-start text-gray-400" aria-controls="faq-0" aria-expanded="false" x-on:click="open=!open">
                                ...
                                <span class="ml-6 h-7 flex items-center">
                                    ...
                                    <svg class="rotate-0 h-6 w-6 transform  transition-all" :class="{'-rotate-180':open,'rotate-0':!open}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
